...
class ProcessSyncChangesOperation: Operation {
    ...
    func resolveConflict(_ recordName: String, managedObjectContext: NSManagedObjectContext) {
        ...
        if serverChangedRecordLastUpdate.compare(localChangedObjectLastUpdate) == ComparisonResult.orderedDescending {
        ...
        } else if serverChangedRecordLastUpdate.compare(localChangedObjectLastUpdate) == ComparisonResult.orderedAscending {
